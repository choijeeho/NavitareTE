namespace NavitaireTE
{
    ...
    internal class AboutBox1 : Form
    {
        ...
        public AboutBox1()
        {
            ...
            this.Text = string.Format(CultureInfo.CurrentCulture, "About {0}", new object[] { this.AssemblyTitle });
            this.labelProductName.Text = this.AssemblyProduct;
            this.labelVersion.Text = string.Format(CultureInfo.CurrentCulture, "Version {0}", new object[] { this.AssemblyVersion });
